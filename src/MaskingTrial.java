    ...
    private class PaintSurface extends JComponent {
        ...
        public void paint(Graphics g) {
            ...
            for (Shape s : shapes) {
                ...
                g2.draw(s);
                g2.setPaint(colors[(colorIndex++) % 3]); //%3 if adding more colors increase
                g2.fill(s); //fill
            }
            
            if (startDrag != null && endDrag != null) {
                g2.setPaint(Color.BLACK); //black line
                Shape r = makeRectangle(startDrag.x, startDrag.y, endDrag.x, endDrag.y); //four corners 
                g2.draw(r);
            }
        }
